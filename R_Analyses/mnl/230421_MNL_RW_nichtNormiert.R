...
### Set core controls
apollo_control = list(
  modelName  ="_MT024_230421",
  modelDescr ="Model in WTP space without interactions, without WTP per minute; MT001, but:
...
apollo_fixed = c("asc_r1", "wtp_mainroad", "wtp_keineInfra", "wtp_splitt")   #Ggf. ändern / an Häufigkeiten ausrichten?
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  b_mainroad = wtp_mainroad * b_kost
  b_sideroad = wtp_sideroad * b_kost
  
  b_keineInfra = wtp_keineInfra * b_kost
  b_streifen = wtp_streifen * b_kost
  b_radweg = wtp_radweg * b_kost
  b_protectedLane = wtp_protectedLane * b_kost
  
  b_splitt = wtp_splitt * b_kost
  b_pflaster = wtp_pflaster * b_kost
  b_asphalt = wtp_asphalt * b_kost
  ...
  V[['r1']]  = asc_r1 +
    ...
    b_mainroad * r1.mainroad + b_sideroad * r1.sideroad + 
    
    b_keineInfra * r1.keineInfra + b_streifen * r1.streifen + 
    b_radweg * r1.radweg + b_protectedLane * r1.protectedLane +
    
    b_splitt * r1.splitt + b_pflaster * r1.pflaster + b_asphalt * r1.asphalt
  ...
  V[['r2']]  = asc_r2 +
    ...
    b_mainroad * r2.mainroad + b_sideroad * r2.sideroad + 
    
    b_keineInfra * r2.keineInfra + b_streifen * r2.streifen + 
    b_radweg * r2.radweg + b_protectedLane * r2.protectedLane+
    
    b_splitt * r2.splitt + b_pflaster * r2.pflaster + b_asphalt * r2.asphalt
...
apollo_lrTest("_MT001_230324",model)
